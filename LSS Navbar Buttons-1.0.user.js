...
(function() {
    ...
    let warningButtons = [
        //createButton('RTW', 'fa-solid fa-truck-medical', 56674133, 'alarm', 'btn-warning'),
        createButton('Rettung', 'fa-solid fa-stethoscope', 56674133, 'alarm_next', 'btn-warning'),
        //createButton('RTH', 'fa-solid fa-helicopter', 56674133, 'alarm_next_alliance', 'btn-warning')
    ];
    ...
    let primaryButtons = [
        //createButton('Blockade', 'fa-solid fa-handcuffs', 63853148, 'alarm', 'btn-primary'),
        createButton('Straßenblockade', 'fas fa-shuttle-van', 63853148, 'alarm_next', 'btn-primary'),
        createButton('SBzufahren', 'fas fa-shuttle-van', 63977176, 'alarm_next', 'btn-primary'),
        createButton('UDGroß', 'fas fa-shuttle-van', 63860769, 'alarm_next', 'btn-primary'),
        createButton('UDGroßzufahren', 'fas fa-shuttle-van', 56674099, 'alarm_next', 'btn-primary'),
